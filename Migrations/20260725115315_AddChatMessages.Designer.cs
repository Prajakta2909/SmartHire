...
namespace SmartHire.Migrations
{
    ...
    [Migration("20260725115315_AddChatMessages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartHire.Models.Interview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartHire.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartHire.Models.CandidateProfile", b =>
                {
                    b.HasOne("SmartHire.Models.ApplicationUser", "ApplicationUser")
                        .WithOne()
                        .HasForeignKey("SmartHire.Models.CandidateProfile", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SmartHire.Models.Interview", b =>
                {
                    b.HasOne("SmartHire.Models.JobApplication", "JobApplication")
                        .WithOne("Interview")
                        .HasForeignKey("SmartHire.Models.Interview", "JobApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SmartHire.Models.Message", b =>
                {
                    ...
                    b.HasOne("SmartHire.Models.ApplicationUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SmartHire.Models.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartHire.Models.Notification", b =>
                {
                    b.HasOne("SmartHire.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
